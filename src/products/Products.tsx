...
export const Products = () => {
    ...
    let filteredProducts = selected ? PRODUCTS.filter((product) => product.stocked) : PRODUCTS;
...
//     }, [products]);
    ...
    const searchInput = <SearchInput searchText={searchText} onSearchTextChange={setSearchText} />;
  
    return (<>
      <ProductsFilter selected={selected} onSelection={handler} searchInput={searchInput}/> <CategoryProducts products={filteredProducts}/>
    </>)
  }
